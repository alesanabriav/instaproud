    ...
    return (
      <Modal show={this.props.modalIsOpen} onHide={this.handleClose}>
          ...
          <Modal.Body>
            ...
            <p>
            El premio denominado -Tarde libre con almuerzo en El Tambor- será entregado al área que primero registre la totalidad de sus colaboradores en la aplicación diligenciando la pantalla de registro de email y contraseña y la de datos personales, se considerarán incompletos los perfiles que no incluyan la totalidad de los campos, incluyendo la fotografía de perfil. El premio consiste en un almuerzo para todos los colaboradores del área ganadora en el restaurante El Tambor de la Calera, incluyendo el transporte de ida y vuelta partiendo y regresando a las instalaciones de la BVC, la tarde de dicho almuerzo también será dada como tarde libre por la BVC para los ganadores.
            </p>
            <p>
